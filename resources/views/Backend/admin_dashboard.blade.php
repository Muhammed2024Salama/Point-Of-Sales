                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-20">
                            <div class="media">
                                <div class="position-relative">
                                    <img class="img-fluid mr-15 avatar-small" src="{{ asset('Backend/assets/images/item/01.png') }}"
                                         alt="">
                                </div>
                        ...
                        <li class="mb-20">
                            <div class="media">
                                <div class="position-relative clearfix">
                                    <img class="img-fluid mr-15 avatar-small" src="{{ asset('Backend/assets/images/item/02.png') }}"
                                         alt="">
                                </div>
                                <div class="media-body">
                        ...
                        <li class="mb-20">
                            <div class="media">
                                <div class="position-relative">
                                    <img class="img-fluid mr-15 avatar-small" src="{{ asset('Backend/assets/images/item/03.png') }}"
                                         alt="">
                                </div>
                                <div class="media-body">
                        ...
                        <li>
                            <div class="media">
                                <div class="position-relative clearfix">
                                    <img class="img-fluid mr-15 avatar-small" src="{{ asset('Backend/assets/images/item/04.png') }}"
                                         alt="">
                                </div>
                                <div class="media-body">
