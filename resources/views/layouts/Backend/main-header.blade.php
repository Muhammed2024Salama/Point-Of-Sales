...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="text-left navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="index.html"><img src="{{ asset('Backend/assets/images/logo-white.png') }}" alt="" ></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('Backend/assets/images/logo-icon-light.png') }}" alt=""></a>
    </div>
    <!-- Top bar left -->
